  ...
  translate = [
    {
      ...
      PRIVACYPOLICY: {
        ...
        H3_3: 'ANPASSEN!!!! All-Inkl',
        TEXT8: 'ANPASSEN!!!! The provider is ALL-INKL.COM - Neue Medien Münnich, owner René Münnich, Hauptstraße 68, 02742 Friedersdorf (hereinafter All-Inkl). For details, see All-Inkl`s privacy policy: https://all-inkl.com/datenschutzinformationen/..',
        TEXT9: 'ANPASSEN!!!! All-Inkl is used on the basis of Art. 6 Para. 1 lit. f GDPR. We have a legitimate interest in our website being presented as reliably as possible. If consent has been requested, processing will be carried out exclusively on the basis of Art. 6 Para. 1 lit. a GDPR and Section 25 Para. 1 TDDDG, insofar as the consent includes the storage of cookies or access to information in the user`s end device (e.g. device fingerprinting) within the meaning of the TDDDG. Consent can be revoked at any time.',
